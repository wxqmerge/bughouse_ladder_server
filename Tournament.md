...
- `https://example.com/dc-dojo-ladder/dist/` → `dc-dojo-ladder-trophies_YYYY-MM-DD.tab`
- `https://example.com/dist/` → `example.com-trophies_YYYY-MM-DD.tab`
...
```
Before awarding trophies:
- For each completed mini-game: run 5 rating recalcs (calculateRatings × 5)
