...
2. **Same-origin auto-detection** — `GET /health` with 3s timeout on `window.location.origin`
...
```
Group	Last Name	First Name	Rating	Rnk	N Rate	Gr		X	Phone	Info	School	Room	1	2	...	31
